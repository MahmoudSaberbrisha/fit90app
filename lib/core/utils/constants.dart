...
const String kDayClassesScreenRoute = '/kDayClassesScreen';

//Spa
const String kSpaScreenRoute = '/kSpaScreen';
...
Color kPrimaryColor = const Color(0xffED402F); // أحمر F I T 9 0
const String logo = "https://alatheertech.com/basma/uploads/logo/noamany.png";

//Color kSecondaryColor = HexColor("#0095b0");
const Color kTextColor = Color(0xFFE5E5E5); // نص فاتح للوضع المظلم
const Color kOutPutContainerTextColor = Color(0xFFB0B0B0); // نص ثانوي فاتح
const Color kPinCodeTextFieldColor = Color(0xFF2A2A2A); // حقول الإدخال داكنة
const Color kSettingIconsColor = Color(0xFF00D774); // أخضر F I T 9 0

// F I T 9 0 Dark Theme Colors
const Color kDarkBackground = Color(0xFF050608); // خلفية داكنة عميقة
const Color kDarkSurface = Color(0xFF1B2030); // سطح داكن
const Color kDarkCard = Color(0xFF11131B); // بطاقات داكنة
const Color kDarkBorder = Color(0xFF404040); // حدود داكنة
const Color kDarkInput = Color(0xFF2A2A2A); // حقول الإدخال داكنة
const Color kSuccessColor = Color(0xFF00D774); // أخضر للنجاح
const Color kErrorColor = Color(0xFFED402F); // أحمر للأخطاء
...
class AppConstant {
  ...
  // TODO: inject secrets from env/secure storage; keep values out of VCS
  static const String mapApi = String.fromEnvironment('MAP_API_KEY', defaultValue: '');
  static const String tapApiKeyLive = String.fromEnvironment('STRIPE_SECRET_KEY', defaultValue: '');
