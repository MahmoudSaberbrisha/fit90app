...
import 'package:fit90_gym_main/core/utils/commons.dart';
import 'package:fit90_gym_main/core/utils/functions/registration_alert.dart';
import 'package:fit90_gym_main/core/utils/gaps.dart';
import 'package:fit90_gym_main/core/widgets/custom_app_bar.dart';
import 'package:fit90_gym_main/core/widgets/custom_button.dart';
import 'package:fit90_gym_main/core/widgets/custom_orders_raw_icon.dart';
import 'package:fit90_gym_main/core/widgets/custom_request_text_field.dart';
...
import 'package:fit90_gym_main/features/subscribtions/presentation/views/widgets/custom_date_picker.dart';
                        ...
                        : CustomButton(
                            ...
                            buttonTapHandler: () {
                              if (BlocProvider.of<PickDateCubit>(
                                ...
                                if (BlocProvider.of<PickDateCubit>(
                                  context,
                                ).valueFrom!.isBefore(DateTime.now())) {
                                  Commons.showToast(
                                    context,
                                    message: "يجب اختيار تاريخ بعد تاريخ اليوم",
                                  );
                                } else {
                                  BlocProvider.of<StopedSubscribtionsCubit>(
                                    ...
                                    widget.exerciseEntity.subscriptionTypeFk,
                                  );
                                }
                              } else {
                                Commons.showToast(
