...
import 'package:fit90_gym_main/features/my_subscribtions/presentation/views/widgets/row_item.dart';
...
class MySubscribtionsDetailsBody extends StatelessWidget {
  ...
  const MySubscribtionsDetailsBody({
    super.key,
    required this.mySubscribtionsEntity,
  });
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        IconText(
                          ...
                          text: mySubscribtionsEntity.fromDateAr.toString(),
                        ),
                        IconText(
                    ...
                    IconText(
                      image: "assets/icon/money_icon.png",
                      text: "${mySubscribtionsEntity.price.toString()} جـنـيـه",
                    ),
                    Gaps.vGap30,
