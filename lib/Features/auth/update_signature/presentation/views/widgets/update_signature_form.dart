...
import 'package:fit90_gym_main/core/widgets/custom_elevated_container.dart';
    ...
    return BlocListener<UpdateSignatureCubit, UpdateSignatureState>(
      ...
      child: Column(
        ...
        children: [
          ...
          GestureDetector(
            onTap: () async {
              await BlocProvider.of<SelectFileCubit>(
                context,
              ).pickFileFromDevice();
            },
              ...
              containerChild: BlocBuilder<SelectFileCubit, SelectFileState>(
                builder: (context, state) {
                  if (state is PickFileState) {
                    ...
                    return Center(child: Text(state.fileName));
                  ...
                  : CustomButton(
                      ...
                      buttonTapHandler: () async {
                        if (selectedFile != null) {
                          var box = Hive.box<EmployeeEntity>(kEmployeeDataBox);
                          BlocProvider.of<UpdateSignatureCubit>(
                            context,
                          ).updateSignature(
