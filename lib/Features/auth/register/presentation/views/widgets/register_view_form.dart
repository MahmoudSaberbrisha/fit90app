...
import 'package:fit90_gym_main/features/auth/register/presentation/views/widgets/custom_drop_down_types_list.dart';
...
class _RegisterViewFormState extends State<RegisterViewForm>
  ...
  void initState() {
    ...
    ssNumberController = TextEditingController();
    typeId = null;
  }
            ...
            child: Column(
              ...
              children: [
                ...
                CustomLoginTextField(
                  ...
                  controller: ssNumberController,
                  imagePath: "assets/icon/person_icon.png",
                  textInputType: TextInputType.number,
                  obscureText: false,
                  stringInTextField: "رقم الهوية الوطنية",
                ),
                CustomLoginTextField(
                    ...
                    return Row(
                      ...
                      children: [
                        ...
                        Radio(
                          ...
                          onChanged: (value) {
                            context.read<RadioCubit>().selectRadio(
                                  value as int,
                                );
